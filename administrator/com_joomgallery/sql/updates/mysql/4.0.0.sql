...
`jg_category_view_subcategories_pagination` VARCHAR(100) NOT NULL DEFAULT 0,
...
`jg_category_view_image_link` VARCHAR(100) NOT NULL DEFAULT "defaultview",
...
`jg_category_view_title_link` VARCHAR(100) NOT NULL DEFAULT "defaultview",
